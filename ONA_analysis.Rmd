...
# 9 no
# units(
#     points = setA$points[SH == "Ezra" & Satisfy == "No"],
#     points_color = "green",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Said" & Satisfy == "No"],
#     points_color = "blue",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Lamont" & Satisfy == "No"],
#     points_color = "brown",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Andre" & Satisfy == "No"],
#     points_color = "purple",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Ed" & Satisfy == "No"],
#     points_color = "yellow",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Grace" & Satisfy == "No"],
#     points_color = "deeppink",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Maya" & Satisfy == "No"],
#     points_color = "Tan",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Natalie" & Satisfy == "No"],
#     points_color = "Cyan",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#     points = setA$points[SH == "Dwayne" & Satisfy == "No"],
#     points_color = "orange",
#     point_position_multiplier = point_position_multiplier,
#     show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
# units(
#   points=set$points[user_name == i],
#   points_color = "black",
#   point_position_multiplier = point_position_multiplier,
#   show_mean = FALSE, show_points = TRUE, with_ci = FALSE) %>%
nodes(
