...
user_data = pd.read_csv("lem-2021-parse-4_all_ranked.csv") # outdated -> TODO: change it to always use current data
...
d = open(mapid + "_init_map.json") # generated from pipline

f = open('multipliers.json')

g = open(mapid + "_reps.json") # generated from pipline #Name, Indicator, Threshold
...
final_df.to_csv(df_name, index=False)
