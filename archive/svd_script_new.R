...
#Ray's Testing for multiple users: 
# mapid = "51482082"
# mapid = "53311543"
# mapid = "53517894"
...
sim_areachange_vote_sampled_name = paste0(mapid, "_sim_result.csv", sep = "")
write.csv(sim_areachange_vote_sampled, sim_areachange_vote_sampled_name)
...
yes_sim_areachange_vote_sampled_mean_name = paste0(mapid, "jais_yes_mean.csv", sep = "")
write.csv(yes_sim_areachange_vote_sampled_mean, yes_sim_areachange_vote_sampled_mean_name)
no_sim_areachange_vote_sampled_mean_name = paste0(mapid, "jais_no_mean.csv", sep = "")
write.csv(no_sim_areachange_vote_sampled_mean, no_sim_areachange_vote_sampled_mean_name)
sub_result = submissions_by_mapid$response$result
sub_result_name = paste0(mapid, "a_sub_result_new.rds", sep = "")
